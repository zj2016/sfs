...
public class EmpCtrl {
    ...
    public ModelAndView addEmp(String sid,String sno,String addsname,int addssex,String addsbirth,String addspro,String addsgrade,
        ...
        if (!sid.equals("")){
            ...
            cmArea1.setAid(city);
            CmCompany  cmCompany=new CmCompany(cname,chr,cphone,cemail,cinfo,cmark,caddress,cmArea1,new DateUtil().convert());
            //招聘表操作
...
//            }
            ...
            CmInter cmInter=new CmInter(cmArea3,cmRecruit,cmStudent,iaddress,1,new DateUtil().StringtoUtilDate(itime),itype);
            //就业是生表操作
            ...
            CmEmp cmEmp=new CmEmp(cmUser,cmJob,cmStudent,new DateUtil().StringtoTime(etime),einfo,rsalary,new DateUtil().SysDate(),flag);
